  ...
  plugins: [
    plugin(function ({ addBase, addComponents, addUtilities, theme }) {
      ...
      addComponents({
        ...
        '.font-xxxxs-r': { fontSize: '8px', lineHeight: '10px', fontWeight: 400 },

        '.font-xxxs-r': { fontSize: '10px', lineHeight: '14px', fontWeight: 400 },

        '.font-xxs-r': { fontSize: '11px', lineHeight: '14px', fontWeight: 400 },
        '.font-xxs-m': { fontSize: '11px', lineHeight: '14px', fontWeight: 500 },
        '.font-xxs-b': { fontSize: '11px', lineHeight: '14px', fontWeight: 600 },

        '.font-xs-r': { fontSize: '12px', lineHeight: '15px', fontWeight: 400 },
        '.font-xs-2r': { fontSize: '12px', lineHeight: '16px', fontWeight: 400 },
        ...
        '.font-xxl-l': { fontSize: '22px', lineHeight: '30px', fontWeight: 400 },
        '.font-xxl-b': { fontSize: '22px', lineHeight: '30px', fontWeight: 600 },

        '.font-xxxl-b': { fontSize: '28px', lineHeight: '35px', fontWeight: 600 },

        '.font-xxxxl-b': { fontSize: '32px', lineHeight: '40px', fontWeight: 600 },
      });
